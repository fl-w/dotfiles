...
let g:which_key_map.f = {
      \ 'name': '+find',
      \ 'w': [':call fzf#__open("Rg")',       'find word'],
      \ 'f': [':call fzf#__open("Files")',    'find files'],
      \ 'c': [':call fzf#__open("Colors")',   'find colors'],
      \ 'C': [':call fzf#__open("Commands")', 'find commands'],
      \ 'B': [':call fzf#__open("Buffers")',  'find buffers'],
      \ 'b': [':call fzf#__open("Marks")',    'find bookmarks'],
      \ 'h': [':call fzf#__open("History")',  'find history'],
      \ '?': [':call fzf#__open("Helptags")', 'find help'],
...
let g:which_key_map.l = {
      ...
      \ 'A' : ['<Plug>(coc-fix-current)',           'apply autofix to current line'],
